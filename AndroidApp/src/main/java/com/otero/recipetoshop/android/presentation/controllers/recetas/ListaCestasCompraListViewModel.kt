package com.otero.recipetoshop.android.presentation.controllers.recetas

import androidx.compose.runtime.MutableState
import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.otero.recipetoshop.Interactors.recetas.listacestascompra.AddNewCestaCompra
import com.otero.recipetoshop.Interactors.recetas.listacestascompra.PrintListaCestasCompra
...
constructor(
    ...
    fun onTriggerEvent(event: ListaCestasCompra):Any {
        when(event){
            is ListaCestasCompra.onAddListaReceta -> {
                val id = addListaReceta(event.nombre)
                return id
            }
//            is ListaCestasCompra.onEnterCestaCompra -> {
