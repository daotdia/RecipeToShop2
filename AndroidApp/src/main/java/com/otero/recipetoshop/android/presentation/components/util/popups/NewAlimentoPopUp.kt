            ...
            Column(
                    ...
                    DropdownMenu(
                        ...
                        TipoUnidad.values().forEach { tipo ->
                            DropdownMenuItem(onClick = {
                                newAlimentoState.value = newAlimentoState.value.copy(tipo = tipo.name)
                                expand.value = false
                            }) {
                                Text(text = tipo.name)
                            }
                ...
                Row(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {
                            newAlimentoState.value = newAlimentoState.value.copy(cantidad = it)                    //En el caso de que el campo de cantidad esté vacío lo indico como error.
                            if(
                                newAlimentoState.value.cantidad.isBlank() ||
